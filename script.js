...
function getPilihanPlayer(comp, player) {
    ...
    if ( player == 'kertas') return(comp == 'batu') ? 'Kamu Menang' : 'Komputer Menang';
    if ( player == 'batu') return (comp == 'gunting') ? 'Kamu Menang' : 'Komputer Menang';
    if ( player == 'gunting') return (comp == 'kertas') ? 'Kamu Menang' : 'Komputer Menang';
